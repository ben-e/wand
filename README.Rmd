...
Finally, for smooth terms, we can plot the smooths. In this case, the only smooth is two dimensional. The `wand_plot_smooths` function returns a list with an entry for each smooth, in this case we're only interested in the first and only.
